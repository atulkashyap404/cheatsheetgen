...
export const metadata: Metadata = {
  metadataBase: new URL('https://your-production-domain.com'), // Replace with your actual domain
  title: {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_IN',
    url: 'https://your-production-domain.com/', // Replace with your actual domain
